...
void ObdMergeModel::listErrorCodes(QStringList listLab)
{
...
void ObdMergeModel::setErrorCodes(QStringList list)
{
...
int ObdMergeModel::getRow() const
{
    return 0;
}
...
bool ObdMergeModel::exportAs(QString format)
{
...
bool ObdMergeModel::exportModifsAs(QString format)
{
    if (format.endsWith("cdfx"))
    {
