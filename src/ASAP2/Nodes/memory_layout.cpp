...
TokenTyp MEMORY_LAYOUT::parseOptPar(QMap<QString, Occurence> *nameOptPar)
{
...
QMap<QString, QString> *MEMORY_LAYOUT::getParameters()
{
...
QString MEMORY_LAYOUT::getPar(QString str)
{
